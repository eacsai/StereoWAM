...
run_id=${RUN_ID:-pi_qwen0p8_camrope_controlvla_branch_initdisp_fromscratch_h100b_$(date +%m%d)}

BS=${BS:-24}                                     # was 12 in V1 — bump for less GA on H100 80GB
MAX_STEPS=${MAX_STEPS:-30000}
GPUS=${GPUS:-0,1}
NUM_PROCESSES=${NUM_PROCESSES:-2}
PORT=${PORT:-29702}                              # +1 vs V1 launcher to avoid clash if both running
