...
init_ckpt=./playground/Checkpoints/goal_pi_qwen0p8_camrope_dc16_epipolar_0526/checkpoints/steps_25000_pytorch_model.pt

run_root_dir=./playground/Checkpoints
run_id=${RUN_ID:-pi_qwen0p8_camrope_epipolar_ffs_controlnet_init_epi25k_h100b_$(date +%m%d)}
...
echo "[launch] init from epipolar 30k: ${init_ckpt}"
