...
run_id=${RUN_ID:-pi_qwen0p8_camrope_frozenvlm_headonly_warmstart_$(date +%m%d)}
...
echo "[launch] Run1 control: QwenPI cam_rope warm-start, frozen VLM, train action head only"
