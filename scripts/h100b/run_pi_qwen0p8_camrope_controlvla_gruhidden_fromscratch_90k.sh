...
run_id=${RUN_ID:-pi_qwen0p8_camrope_controlvla_gruhidden_fromscratch_90k_h100b_$(date +%m%d)}

BS=${BS:-24}                                     # eff_batch = BS x NUM_PROCESSES x GA(2) = 96
MAX_STEPS=${MAX_STEPS:-90000}
GPUS=${GPUS:-0,1}
NUM_PROCESSES=${NUM_PROCESSES:-2}
PORT=${PORT:-29706}                              # distinct from controlvla(29701)/from_baseline96(29703)
