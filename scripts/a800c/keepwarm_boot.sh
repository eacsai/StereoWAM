...
export QUEUE_FILE=${QUEUE_FILE:-${REPO}/scripts/a800c/keepwarm_queue.txt}
export STATE_DIR=${STATE_DIR:-${REPO}/playground/Checkpoints/keepwarm_state_a800c}
...
mkdir -p "${STATE_DIR}"
exec bash "${REPO}/scripts/a800c/keep_warm_queue_runner.sh"
